// Package stats 对 BCHK 容器执行统计分析：载荷大小分布、类型频率、熵估算等。
package stats
...
// AverageEntropy 计算所有记录载荷的平均 Shannon 熵。
...
// TypeDistribution 返回各类型的占比（0.0-1.0）。
